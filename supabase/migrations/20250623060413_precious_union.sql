...
DROP POLICY IF EXISTS "Profiles are viewable by everyone including anonymous users" ON profiles;
DROP POLICY IF EXISTS "Users can create their own profile" ON profiles;
DROP POLICY IF EXISTS "Users can update their own profile basic info" ON profiles;
DROP POLICY IF EXISTS "Admins can update any profile" ON profiles;
DROP POLICY IF EXISTS "Users can delete their own profile" ON profiles;
DROP POLICY IF EXISTS "Admins can delete any profile" ON profiles;
DROP POLICY IF EXISTS "Service role has full access to profiles" ON profiles;

DROP POLICY IF EXISTS "Ideas are viewable by everyone including anonymous users" ON ideas;
...
DROP POLICY IF EXISTS "Representatives can update official proposals" ON ideas;
...
DROP POLICY IF EXISTS "Users can vote once per idea" ON votes;
DROP POLICY IF EXISTS "Users can update their own votes" ON votes;
DROP POLICY IF EXISTS "Users can delete their own votes" ON votes;
DROP POLICY IF EXISTS "Admins can manage any vote" ON votes;

DROP POLICY IF EXISTS "Comments are viewable by everyone" ON comments;
DROP POLICY IF EXISTS "Users can create comments" ON comments;
DROP POLICY IF EXISTS "Users can update their own comments" ON comments;
DROP POLICY IF EXISTS "Users can delete their own comments" ON comments;
DROP POLICY IF EXISTS "Admins can manage any comment" ON comments;
...
DROP POLICY IF EXISTS "Admins and authorities can view audit log" ON audit_log;
DROP POLICY IF EXISTS "Service role has full access to audit log" ON audit_log;

DROP POLICY IF EXISTS "Admins can view audit log" ON admin_audit_log;

DROP POLICY IF EXISTS "Error codes are viewable by everyone" ON error_codes;
